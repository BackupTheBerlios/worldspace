...
int render_mad(modelo *mad) {
      ...
      for (j = 0; j < mad->n_caras; j++) {
        ...
        glVertex3f(mad->triangulos[j].vertices[0].x*30,mad->triangulos[j].vertices[0].y*30,mad->triangulos[j].vertices[0].z*30);
        ...
        glVertex3f(mad->triangulos[j].vertices[1].x*30,mad->triangulos[j].vertices[1].y*30,mad->triangulos[j].vertices[1].z*30);
        ...
        glVertex3f(mad->triangulos[j].vertices[2].x*30,mad->triangulos[j].vertices[2].y*30,mad->triangulos[j].vertices[2].z*30);
