...
posisición , el tamaño y el texto. Se pueden
...
/*!
Nuevas versión de print que imprime una línea y la alínea
*/

extern int print_p(FUENTE *fuente,char align,float y,float tam,char *texto, ...);
