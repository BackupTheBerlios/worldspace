...
gearApp::gearApp (char *name, int sdi, int h, int w):
vApp (name, sdi, h, w)
{
...
vWindow *
gearApp::NewAppWin (vWindow * win, char *name,
...
int
gearApp::CloseAppWin (vWindow * win)
{
...
void
gearApp::AppCommand (vWindow * win, ItemVal id, ItemVal val, CmdType cType)
{
...
void
gearApp::KeyIn (vWindow * win, vKey key, unsigned int shift)
{
